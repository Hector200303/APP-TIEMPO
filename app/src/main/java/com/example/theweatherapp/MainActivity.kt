            ...
            Column(modifier = Modifier
                ...
                weatherData?.let {
                    Row(modifier = Modifier.fillMaxWidth(),
                        ...
                        WeatherCard(label = "Ciudad", value = it.name, icon = Icons.Default.Place)
                        WeatherCard(label = "Temperatura", value = "${it.main.temp}°C", icon = Icons.Default.Star)
                    }
                    Row(modifier = Modifier.fillMaxWidth(),
                        horizontalArrangement = Arrangement.SpaceEvenly
                    ) {
                        WeatherCard(label = "Humedad", value = "${it.main.humidity}%", icon = Icons.Default.Warning)
